...
HomeDetail.create(name: "Mully Children’s Home", description: "Since 1989, Mully Children’s Home has rehabilitated and cared for over 12, 000 children and currently has over 3,000 children in Ndalani, Yatta, Kitale, Kilifi, Lodwar and Dar-es-Salaam in Tanzania.", image_url: "https://i.ytimg.com/vi/L3HGRf4noSU/hqdefault.jpg?sqp=-oaymwEZCNACELwBSFXyq4qpAwsIARUAAIhCGAFwAQ==&rs=AOn4CLDKdIdtQTTSXRZ6pG04i90XvpEaJQ", address: "Wood Gardens, Off Wood Avenue", email: "mcf@mullychildrensfamily.org", phone_number: "0733333121")
